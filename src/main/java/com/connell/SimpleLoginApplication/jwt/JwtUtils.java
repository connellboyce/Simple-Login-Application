package com.connell.SimpleLoginApplication.jwt;

import com.connell.SimpleLoginApplication.service.UserDetailsImpl;
...
public class JwtUtils {
    ...
    @Value("${simpleloginapplication.app.jwtSecret}")
    private String jwtSecret;

    @Value("${simpleloginapplication.app.jwtExpirationMs}")
